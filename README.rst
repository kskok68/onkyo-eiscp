...
- A webpage that allows you to browse and search the commands in a human-friendly way, and which is generated from the YAML file.  Opening the file `webview/dist/index.html` in a browser will allow you to use it.
